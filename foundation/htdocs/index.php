...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN">
	<head>
		...
		<meta name="SubversionID" content="$Id: index.php 113 2007-02-25 08:53:32Z livid $" />
	...
	<body>
		<div align="center">
			...
			<div class="f_box">
				<div class="f_box_t" align="left">当前募捐进度 | <a href="details.php?project=<?php echo $project_current; ?>"><?php echo $project_current_title; ?></a></div>
				<div class="f_box_m" align="center">
					<div style="width: 400px; padding: 1px 1px 5px 1px;" align="right">
						<div style="width: 400px; color: #333; font-size: 12px;" align="center"><?php echo $percentage_text; ?> 共 <?php echo $amount_total; ?> 元已完成，来自于 <a href="details.php?project=<?php echo $project_current; ?>"><?php echo $donation_count; ?></a> 次捐助</div>
					</div>
