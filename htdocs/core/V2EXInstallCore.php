...
$i->vxSetupBoard('usdjpy', 'USD/JPY', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('gbpusd', 'GBP/USD', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('eurusd', 'EUR/USD', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('usdcad', 'USD/CAD', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('eurjpy', 'EUR/JPY', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('usdchf', 'USD/CHF', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('audusd', 'AUD/USD', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('eurgbp', 'EUR/GBP', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('eurchf', 'EUR/CHF', 452, 452, 1, 2, '', '');
$i->vxSetupBoard('chfjpy', 'CHF/JPY', 452, 452, 1, 2, '', '');
...
$i->vxSetupBoard('600128', '弘业股份', 452, 452, 1, 2, '弘业股份 (600128)', '');
...
$i->vxSetupBoard('600146', '大元股份', 452, 452, 1, 2, '大元股份 (600146)', '');
$i->vxSetupBoard('600148', '长春一东', 452, 452, 1, 2, '长春一东 (600148)', '');
$i->vxSetupBoard('600149', '华夏建通', 452, 452, 1, 2, '华夏建通 (600149)', '');
$i->vxSetupBoard('600150', '沪东重机', 452, 452, 1, 2, '沪东重机 (600150)', '');
$i->vxSetupBoard('600151', '航天机电', 452, 452, 1, 2, '航天机电 (600151)', '');
$i->vxSetupBoard('600152', '维科精华', 452, 452, 1, 2, '维科精华 (600152)', '');
...
$i->vxSetupBoard('600159', '大龙地产', 452, 452, 1, 2, '大龙地产 (600159)', '');
$i->vxSetupBoard('600160', '巨化股份', 452, 452, 1, 2, '巨化股份 (600160)', '');
$i->vxSetupBoard('600161', '天坛生物', 452, 452, 1, 2, '天坛生物 (600161)', '');
$i->vxSetupBoard('600162', '香江控股', 452, 452, 1, 2, '香江控股 (600162)', '');
$i->vxSetupBoard('600163', '福建南纸', 452, 452, 1, 2, '福建南纸 (600163)', '');
$i->vxSetupBoard('600165', '宁夏恒力', 452, 452, 1, 2, '宁夏恒力 (600165)', '');
$i->vxSetupBoard('600166', '福田汽车', 452, 452, 1, 2, '福田汽车 (600166)', '');
$i->vxSetupBoard('600167', '沈阳新开', 452, 452, 1, 2, '沈阳新开 (600167)', '');
$i->vxSetupBoard('600168', '武汉控股', 452, 452, 1, 2, '武汉控股 (600168)', '');
...
$i->vxSetupBoard('600172', '黄河旋风', 452, 452, 1, 2, '黄河旋风 (600172)', '');
$i->vxSetupBoard('600175', '美都控股', 452, 452, 1, 2, '美都控股 (600175)', '');
$i->vxSetupBoard('600176', '中国玻纤', 452, 452, 1, 2, '中国玻纤 (600176)', '');
$i->vxSetupBoard('600177', '雅戈尔', 452, 452, 1, 2, '雅戈尔 (600177)', '');
$i->vxSetupBoard('600178', '东安动力', 452, 452, 1, 2, '东安动力 (600178)', '');
$i->vxSetupBoard('600179', '黑化股份', 452, 452, 1, 2, '黑化股份 (600179)', '');
$i->vxSetupBoard('600180', '九发股份', 452, 452, 1, 2, '九发股份 (600180)', '');
$i->vxSetupBoard('600182', 'S佳通', 452, 452, 1, 2, 'S佳通 (600182)', '');
$i->vxSetupBoard('600183', '生益科技', 452, 452, 1, 2, '生益科技 (600183)', '');
$i->vxSetupBoard('600184', '新华光', 452, 452, 1, 2, '新华光 (600184)', '');
$i->vxSetupBoard('600185', '海星科技', 452, 452, 1, 2, '海星科技 (600185)', '');
$i->vxSetupBoard('600186', '莲花味精', 452, 452, 1, 2, '莲花味精 (600186)', '');
$i->vxSetupBoard('600188', '兖州煤业', 452, 452, 1, 2, '兖州煤业 (600188)', '');
$i->vxSetupBoard('600189', '吉林森工', 452, 452, 1, 2, '吉林森工 (600189)', '');
$i->vxSetupBoard('600190', '锦州港', 452, 452, 1, 2, '锦州港 (600190)', '');
$i->vxSetupBoard('600191', '华资实业', 452, 452, 1, 2, '华资实业 (600191)', '');
$i->vxSetupBoard('600192', '长城电工', 452, 452, 1, 2, '长城电工 (600192)', '');
...
$i->vxSetupBoard('600478', '力元新材', 452, 452, 1, 2, '力元新材 (600478)', '');
...
$i->vxSetupBoard('600538', '北海国发', 452, 452, 1, 2, '北海国发 (600538)', '');
...
$i->vxSetupBoard('600636', '三爱富', 452, 452, 1, 2, '三爱富 (600636)', '');
...
$i->vxSetupBoard('600648', '外高桥', 452, 452, 1, 2, '外高桥 (600648)', '');
...
$i->vxSetupBoard('600742', '一汽四环', 452, 452, 1, 2, '一汽四环 (600742)', '');
...
$i->vxSetupBoard('600783', '鲁信高新', 452, 452, 1, 2, '鲁信高新 (600783)', '');
...
$i->vxSetupBoard('601328', '交通银行', 452, 452, 1, 2, '交通银行 (601328)', '');
...
$i->vxSetupBoard('000572', '海马股份', 452, 452, 1, 2, '海马股份 (000572)', '');
$i->vxSetupBoard('000576', '广东甘化', 452, 452, 1, 2, '广东甘化 (000576)', '');
...
$i->vxSetupBoard('000752', '西藏发展', 452, 452, 1, 2, '西藏发展 (000752)', '');
...
$i->vxSetupBoard('f510050', '上证50ETF', 452, 452, 1, 2, '上证50ETF (510050)', '');
...
$i->vxSetupBoard('ozzyosbourne', "Ozzy Osbourne", 220, 220, 1, 2, '', '');
...
$i->vxSetupBoard('opeth', "Opeth", 220, 220, 1, 2, '', '');
$i->vxSetupBoard('toto', "Toto", 220, 220, 1, 2, '', '');
$i->vxSetupBoard('ironmaiden', "Iron Maiden", 220, 220, 1, 2, '', '');
$i->vxSetupBoard('rhapsody', "Rhapsody", 220, 220, 1, 2, '', '');
$i->vxSetupBoard('nickelback', "Nickelback", 220, 220, 1, 2, '', '');
...
$i->vxSetupBoard('kyoto', '京都', 2, 2, 1, 2, '', '');
...
$i->vxSetupBoard('stuttgart', 'Stuttgart', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('hamburg', 'Hamburg', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('frankfurt', 'Frankfurt', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('munich', 'Munich', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('bonn', 'Bonn', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('potsdam', 'Potsdam', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('bochum', 'Bochum', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('cologne', 'Cologne', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('aachen', 'Aachen', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('dresden', 'Dresden', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('erfurt', 'Erfurt', 2, 2, 1, 2, '', '');
$i->vxSetupBoard('kiel', 'Kiel', 2, 2, 1, 2, '', '');
...
$i->vxSetupBoard('movabletype', 'Movable Type', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('gecko', "Gecko", 3, 3, 1, 2, '', '');
$i->vxSetupBoard('webkit', "WebKit", 3, 3, 1, 2, '', '');
$i->vxSetupBoard('qemu', "QEMU", 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('f8', 'Facebook Platform', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('sharepoint', 'SharePoint', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('mac', 'Mac', 3, 3, 1, 2, 'We are APPLEOHOLICS!', '');
	...
	$i->vxSetupChannelByName('mac', 'http://feeds.tuaw.com/weblogsinc/tuaw');
...
$i->vxSetupBoard('win2003', 'Windows Server 2003', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('win2008', 'Windows Server 2008', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('webobjects', 'WebObjects', 3, 3, 1, 2, '', '');
	$i->vxSetupRelatedByName('webobjects', 'http://www.apple.com/webobjects/', 'WebObjects');
...
$i->vxSetupBoard('minix', 'MINIX', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('openbsd', 'OpenBSD', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('xen', 'Xen', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('datastructure', '数据结构', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('s3', 'Amazon S3', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('ec2', 'Amazon EC2', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('zfs', 'ZFS', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('rest', 'REST', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('pd', 'Personal Datacenter', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('xul', 'XUL', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('lua', 'LUA', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('groovy', 'Groovy', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('ps1', 'PlayStation 1', 3, 3, 1, 2, '', '');
$i->vxSetupBoard('ps2', 'PlayStation 2', 3, 3, 1, 2, '', '');
...
$i->vxSetupBoard('cc', 'Creative Commons', 4, 4, 1, 2, '', '');
	$i->vxSetupRelatedByName('cc', 'http://creativecommons.org/', 'Creative Commons');
...
$i->vxSetupBoard('environmentism', '环境主义', 4, 4, 1, 2, '', '');
...
$i->vxSetupBoard('babytree', '宝宝树', 4, 4, 1, 2, '', '');
$i->vxSetupBoard('mytupa', 'myTupa', 4, 4, 1, 2, '', '');	
$i->vxSetupBoard('kooxoo', '酷讯', 4, 4, 1, 2, '', '');
	$i->vxSetupChannelByName('kooxoo', 'http://blog.kooxoo.com/index.php/feed/atom/');
	$i->vxSetupRelatedByName('kooxoo', 'http://www.kooxoo.com/', '酷讯');
...
$i->vxSetupBoard('bookcrossing', '图书漂流', 4, 4, 1, 2, '', '');
...
$i->vxSetupBoard('v2ex', 'V2EX', 4, 4, 1, 2, 'Latest from V2EX', 'V2EX | software for internet');
	$i->vxSetupRelatedByName('v2ex', 'http://labs.v2ex.com/', 'V2EX Labs');
	$i->vxSetupChannelByName('v2ex', 'http://v2ex.org/?feed=rss2');
	$i->vxSetupChannelByName('v2ex', 'http://del.icio.us/rss/');
