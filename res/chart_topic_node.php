<!-- amcolumn script-->
  <script type="text/javascript" src="/img/am/amcolumn/swfobject.js"></script>
	<div id="flashcontent_topic_node">
	...
	<script type="text/javascript">
		...
		so.addVariable("settings_file", escape("/data?m=chart_settings_topic_node"));
		so.addVariable("data_file", escape("/data?m=chart_data_topic_node"));
		so.addVariable("preloader_color", "#FFFFFF");
		so.write("flashcontent_topic_node");
		// ]]>
	</script>
