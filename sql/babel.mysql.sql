...
CREATE TABLE `babel_dry_item` (
  ...
  `itm_pid` int(10) unsigned NOT NULL DEFAULT '0',
  `itm_name` varchar(100) NOT NULL DEFAULT '',
  `itm_title` varchar(100) DEFAULT NULL,
  `itm_substance` text,
  `itm_revisions` int(10) unsigned NOT NULL DEFAULT '0',
  `itm_password` varchar(40) DEFAULT NULL,
  `itm_permission` int(10) unsigned NOT NULL DEFAULT '0',
  `itm_type` int(10) unsigned NOT NULL,
