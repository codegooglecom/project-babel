...
*  Subversion Keywords:
*
*  $Id: Utilities.php 60 2007-02-05 08:00:48Z livid $
*  $LastChangedDate: 2007-02-05 16:00:48 +0800 (Mon, 05 Feb 2007) $
*  $LastChangedRevision: 60 $
*  $LastChangedBy: livid $
*  $URL: http://svn.cn.v2ex.com/svn/babel/trunk/htdocs/core/Utilities.php $
*/
...
function exception_message($func = '') {
	...
	switch ($func) {
		case 'off':
			...
			$o .= 'Babel führt ein Hauptaufsteigen jetzt, der Service ist temporäres nicht erreichbares, überprüfen bitte zurück später durch, danke!<br /><br />';
